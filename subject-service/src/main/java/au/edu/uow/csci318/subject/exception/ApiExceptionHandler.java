...
public class ApiExceptionHandler {
 ...
 @ExceptionHandler(IdentityServiceException.class) ResponseEntity<ErrorBody> identityUnavailable(RuntimeException e,HttpServletRequest r){return body(HttpStatus.SERVICE_UNAVAILABLE,e,r,null);}
 @ExceptionHandler(UnauthorizedIdentityException.class) ResponseEntity<ErrorBody> unauthorized(RuntimeException e,HttpServletRequest r){return body(HttpStatus.UNAUTHORIZED,e,r,null);}

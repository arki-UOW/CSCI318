...
@Entity
@Table(name="subjects", uniqueConstraints=@UniqueConstraint(columnNames={"owner_id", "code"}))
public class Subject {
    ...
    protected Subject() {}
    public Subject(UUID ownerId, String code, String name, Integer creditPoints, int target) {
        this.id=UUID.randomUUID(); this.ownerId=java.util.Objects.requireNonNull(ownerId); this.code=normaliseCode(code); this.name=requireText(name,"Subject name");
    ...
    public UUID getId(){return id;} public UUID getOwnerId(){return ownerId;} public String getCode(){return code;} public String getName(){return name;} public Integer getCreditPoints(){return creditPoints;} public int getWeeklyStudyTargetMinutes(){return weeklyStudyTargetMinutes;}
}

...
public final class SubjectDtos {
 private SubjectDtos(){}
 public record AssessmentCandidate(@NotBlank String title,String type,@DecimalMin("0.0") @DecimalMax("100.0") Double weighting,LocalDate dueDate,@Min(1) @Max(52) Integer dueWeek,String description,@Positive Double estimatedHours,Double confidence,String warning){}

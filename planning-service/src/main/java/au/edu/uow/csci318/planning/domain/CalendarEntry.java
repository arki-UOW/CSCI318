...
@Table(name = "calendar_entries", indexes = {
        @Index(name = "idx_calendar_owner_start", columnList = "owner_id,start_at")
})
public class CalendarEntry {
    public enum EntryType { TASK, STUDY_SESSION, REVIEW }
    public enum EntryStatus { PLANNED, COMPLETED }
    public enum Origin { MANUAL, AI_PLAN, SPACED_REPETITION }
    ...
    @Enumerated(EnumType.STRING) @Column(nullable = false) private EntryType type;
    @Column(nullable = false) private LocalDateTime startAt;
    @Column(nullable = false) private LocalDateTime endAt;
    @Enumerated(EnumType.STRING) @Column(nullable = false) private EntryStatus status;
    @Enumerated(EnumType.STRING) @Column(nullable = false) private Origin origin;
    @Column(nullable = false) private boolean spacedRepetition;
    @Column(nullable = false) private int repetitionStage;
    ...
    public CalendarEntry(UUID ownerId, UUID subjectId, UUID assessmentId, UUID planId,
                         UUID sourceEntryId, String title, String description, EntryType type,
                         LocalDateTime startAt, LocalDateTime endAt, Origin origin,
                         boolean spacedRepetition, int repetitionStage) {
        id = UUID.randomUUID();
    ...
    public void edit(String title, String description, EntryType type, LocalDateTime startAt,
                     LocalDateTime endAt, UUID subjectId, UUID assessmentId,
    ...
    public boolean isSpacedRepetition() { return spacedRepetition; }
    public int getRepetitionStage() { return repetitionStage; }

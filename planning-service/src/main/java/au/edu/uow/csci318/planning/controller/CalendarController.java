...
public class CalendarController {
    ...
    @PatchMapping("/{id}")
    public EntryResponse update(@RequestHeader("Authorization") String authorization,
                                @PathVariable("id") UUID id, @Valid @RequestBody SaveRequest request) {
    ...
    public CompletionResponse complete(@RequestHeader("Authorization") String authorization,
                                       @PathVariable("id") UUID id) {
        return service.complete(identity.require(authorization), id);
    }
}

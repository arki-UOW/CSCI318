...
public final class AssessmentDtos{private AssessmentDtos(){}
 ...
 public record CreateRequest(@NotNull UUID subjectId,@NotBlank String title,String type,@DecimalMin("0")@DecimalMax("100")Double weighting,LocalDate dueDate,@Min(1)@Max(52)Integer dueWeek,String description,@Positive Integer estimatedMinutes,Priority priority){}

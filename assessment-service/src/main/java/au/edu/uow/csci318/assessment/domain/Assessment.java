...
@Table(
    name = "assessments",
    uniqueConstraints = @UniqueConstraint(columnNames = {"owner_id", "subject_id", "title"}))
public class Assessment {
  ...
  public void changeDeadline(LocalDate date, Integer week) {
    if (date != null && date.isBefore(LocalDate.of(2000, 1, 1)))
  ...
  public void changeWeighting(Double value) {
  ...
  public void changeEstimatedWorkload(Integer minutes) {
    if (minutes != null && minutes < 0)
      throw new IllegalArgumentException("Estimated workload cannot be negative");
    estimatedMinutes = minutes;
    touch();
  }

  public void changePriority(Priority value) {

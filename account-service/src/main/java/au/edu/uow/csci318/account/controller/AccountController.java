...
public class AccountController {
  ...
  public AccountResponse session(
  ...
  @PatchMapping("/profile/timezone/detected")
  public AccountResponse detectedTimezone(
      @RequestHeader("Authorization") String authorization,
      @Valid @RequestBody DetectedTimezoneRequest request) {
    return service.updateDetectedTimezone(authorization, request);
  }

  @PatchMapping("/settings/theme")
  public AccountResponse theme(
      @RequestHeader("Authorization") String authorization,
  ...
  public AccountResponse navigation(
      @RequestHeader("Authorization") String authorization,

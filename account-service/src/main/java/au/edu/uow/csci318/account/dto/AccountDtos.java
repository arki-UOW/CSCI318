...
public final class AccountDtos {
  ...
  public record ProfileUpdateRequest(
      ...
      @Size(max = 14_000_000) String profilePicture) {}

  public record DetectedTimezoneRequest(@NotBlank String timezone) {}

  public record ThemeUpdateRequest(
      @NotBlank String primaryColor,
      @NotBlank String accentColor,
      @NotBlank String backgroundColor,
      @NotBlank String surfaceColor,
      @NotBlank String textColor,
      String navigationColor) {}

  public record NavigationUpdateRequest(
      @NotEmpty @Size(max = 6) List<@NotBlank String> navigationOrder) {}
